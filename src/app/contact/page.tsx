          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 max-w-6xl mx-auto">
              ...
              <div className="text-center md:col-span-6">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Offices</h3>
                <p className="text-muted-foreground">77 W Wacker Dr Suite 4500, Chicago, IL, 60601</p>
                <p className="text-muted-foreground" style={{ marginTop: '10px' }}>1 Marina Park Drive, Suite 1410, Boston, MA, 02210</p>
              </div>
